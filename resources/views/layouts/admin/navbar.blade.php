        ...
        <ul class="navbar-nav flex-row">
            <li class="nav-item dropdown language-dropdown ml-1  ml-lg-0">
                <a href="javascript:void(0);" class="nav-link dropdown-toggle" id="flagDropdown" data-toggle="dropdown"
                    ...
                    <img src="{{ asset('assets/admin/assets/img/ca.svg') }}" alt=""> <span
                ...
                <div class="dropdown-menu position-absolute" aria-labelledby="flagDropdown">
                    <a class="dropdown-item" href="javascript:void(0);"><img
                            src="{{ asset('assets/admin/assets/img/de.svg') }}" class="flag-width" alt="">
                        &#xA0;German</a>
                    <a class="dropdown-item" href="javascript:void(0);"><img
                            src="{{ asset('assets/admin/assets/img/jp.svg') }}" class="flag-width" alt="">
                        &#xA0;Japanese</a>
                    <a class="dropdown-item" href="javascript:void(0);"><img
                            src="{{ asset('assets/admin/assets/img/fr.svg') }}" class="flag-width" alt="">
                        &#xA0;French</a>
                    <a class="dropdown-item" href="javascript:void(0);"><img
                            src="{{ asset('assets/admin/assets/img/ru.svg') }}" class="flag-width" alt="">
                        &#xA0;Russian</a>
                    <a class="dropdown-item" href="javascript:void(0);"><img
                            src="{{ asset('assets/admin/assets/img/ca.svg') }}" class="flag-width" alt="">
                        &#xA0;English</a>
                </div>
            </li>
        </ul>
                        ...
                        <div class="media">
                            <div class="usr-img online mr-3">
                                <img class="usr-img rounded-circle"
                                    src="{{ asset('assets/admin/assets/img/90x90.jpg') }}"
                            ...
                            <div class="notification-item position-relative  mb-3">
                                ...
                                <ul class="list-inline badge-collapsed-img mt-3">
                                    <li class="list-inline-item chat-online-usr">
                                        <img src="{{ asset('assets/admin/assets/img/90x90.jpg') }}"
                                            alt="admin-profile" class="ml-0">
                                    </li>
                                    <li class="list-inline-item chat-online-usr">
                                        <img src="{{ asset('assets/admin/assets/img/90x90.jpg') }}"
                                            alt="admin-profile">
                                ...
                                <ul class="list-inline badge-collapsed-img mt-3">
                                    <li class="list-inline-item chat-online-usr">
                                        <img alt="admin-profile"
                                            src="{{ asset('assets/admin/assets/img/90x90.jpg') }}" class="ml-0">
                                    </li>
                                    <li class="list-inline-item chat-online-usr">
                                        <img alt="admin-profile"
                                            src="{{ asset('assets/admin/assets/img/90x90.jpg') }}">
